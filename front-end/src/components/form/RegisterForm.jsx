...
const Letsthegamebegins=()=>{
    return(
        <div className='h-screen md:w-[85%] w-full  ml-auto'>
        <div className="form-container h-full w-full relative flex items-center justify-center md:px-[20px] md:py-[100px] text-white bg-red-300">
            <div className="bg-black w-full h-full xl:h-[460px] xl:w-[460px] md:h-[380px] md:w-[380px] lg:h-[400px] lg:w-[400px]  flex md:items-center items-start justify-center md:p-5 px-2 md:px-0 relative md:rotate-45">
                <div className='md:rotate-[-45deg] flex md:items-center items-start justify-start flex-col h-fit md:w-[70%]  md:translate-x-[-20px] md:translate-y-[-20px] p-2 md:p-0'>
                    ...
                    <div className="w-full py-2 px-2 md:px-0 mt-8 md:mt-0">
                        ...
                        <p className='mb-2 xl:text-[14px] text-[12px] text-[#BBBBBB]'>if you get qualified for the finals you will have to travel to ESTIN Bejaia and compete, do you agree?</p>
                        <div className='w-full bg-[#F5F5F5] p-2'>
                            <select className='outline-none bg-transparent text-black w-full px-4 border-none '>
        ...
        <div className="form-container h-full w-full relative flex items-center justify-center md:px-[20px] md:py-[100px] text-white bg-red-300">
            <div className="bg-black w-full h-full xl:h-[460px] xl:w-[460px] md:h-[380px] md:w-[380px] lg:h-[400px] lg:w-[400px]  flex md:items-center items-start justify-center md:p-5 px-2 md:px-0 relative md:rotate-45">
                <div className='md:rotate-[-45deg] flex md:items-center items-start justify-start flex-col h-fit md:w-[70%]  md:translate-x-[-20px] md:translate-y-[-20px] p-2 md:p-0'>
                    ...
                    <div className='md:text-center mt-2 pt-4 md:py-0'>
                        <h1 className='capitalize text-white xl:text-[32px] lg:text-[24px] md:text-[22px] text-[32px]  font-bold'>We will need <br className='md:hidden'/>your <br /><span className='text-[#FD3434]'>Contact</span></h1>
                    </div>
                    <div className='flex items-center flex-col justify-center xl:py-4 lg:py-2 w-full md:px-0 px-3 py-4 md:py-0'>
                        <input type="email" className='outline-none xl:text-[16px] text-[14px] py-1 bg-transparent border-b-[1px] border-[#FD3434] border-solid w-full mb-4' placeholder="Email" id='email' />
                        <input type="tel" className='outline-none xl:text-[16px] text-[14px] py-1 bg-transparent border-b-[1px] border-[#FD3434] border-solid w-full' placeholder='Phone Number' id='PH-number'/>
                    </div>
                    <div className="w-full py-2 px-2 md:px-0">
